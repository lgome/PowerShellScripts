...
$e=plink -ssh lgomez@prdus2meseig03 -pw Qw6666*/  "sh /home/lgomez/scripts/perrostatus.sh"
...
$e=plink -ssh lgomez@prdus2meseig03 -pw Qw6666*/  "sh /home/lgomez/scripts/RStringstatus.sh"
$update_data = "UPDATE $table SET IsRunning = '$e' WHERE ProcessName = 'RestartScript_by_String'"
Invoke-Sqlcmd -ServerInstance $SQLServer -Database $db1 -Query $update_data


$e=plink -ssh lgomez@prdus2meseig03 -pw Qw6666*/  "sh /home/lgomez/scripts/Rtimestatus.sh"
$update_data = "UPDATE $table SET IsRunning = '$e' WHERE ProcessName = 'RestartScript_by_time'"
Invoke-Sqlcmd -ServerInstance $SQLServer -Database $db1 -Query $update_data

$e=plink -ssh lgomez@prdus2meseig03 -pw Qw6666*/  "sh /home/lgomez/scripts/IOSstatus.sh"
$update_data = "UPDATE $table SET IsRunning = '$e' WHERE ProcessName = 'SosMiiDownload_IOS'"
Invoke-Sqlcmd -ServerInstance $SQLServer -Database $db1 -Query $update_data

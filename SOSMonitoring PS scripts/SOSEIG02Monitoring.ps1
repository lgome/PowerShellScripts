...
$e=plink -ssh lgomez@prdus2meseig02 -pw Qw6666*/  "sh /home/lgomez/scripts/perrostatus.sh"
...
$e=plink -ssh lgomez@prdus2meseig02 -pw Qw6666*/  "sh /home/lgomez/scripts/RStringstatus.sh"
$update_data = "UPDATE $table SET IsRunning = '$e' WHERE ProcessName = 'RestartScript_by_String'"
Invoke-Sqlcmd -ServerInstance $SQLServer -Database $db1 -Query $update_data


$e=plink -ssh lgomez@prdus2meseig02 -pw Qw6666*/  "sh /home/lgomez/scripts/Rtimestatus.sh"
$update_data = "UPDATE $table SET IsRunning = '$e' WHERE ProcessName = 'RestartScript_by_time'"
Invoke-Sqlcmd -ServerInstance $SQLServer -Database $db1 -Query $update_data

$e=plink -ssh lgomez@prdus2meseig02 -pw Qw6666*/  "sh /home/lgomez/scripts/confactstatus.sh"
$update_data = "UPDATE $table SET IsRunning = '$e' WHERE ProcessName = 'SosMiiConfirm_activity'"
Invoke-Sqlcmd -ServerInstance $SQLServer -Database $db1 -Query $update_data
